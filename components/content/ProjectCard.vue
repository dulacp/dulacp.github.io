...
<template>
  <a :href="url" target="_blank" class="not-prose flex items-center p-4 bg-white rounded-lg border-gray-200 dark:border-transparent border-2 shadow-sm hover:shadow-lg transition duration-300">
